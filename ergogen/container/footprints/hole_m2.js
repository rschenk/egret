...
module.exports = {
    ...
    (module MountingHole_2.2mm_M2${p.param.plated ? '_Pad' : ''} (layer F.Cu) (tedit 56D1B4CB)
        (descr "Mounting Hole 2.2mm, ${p.param.plated ? '' : 'no annular,'} M2")
        (tags "mounting hole 2.2mm ${p.param.plated ? '' : 'no annular'} m2")
        (attr virtual)
